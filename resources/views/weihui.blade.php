...
<title>源码库提醒您：系统正在维护，请稍后访问！</title>
<style type="text/css">
/*==== RESET ====*/
...
.box{width:624px;height:188px;padding:99px 30px 0 184px;background:url({{ url('homes/images/maintenance.png') }}) no-repeat 0 0;position:absolute;margin:-144px 0 0 -419px;top:50%;left:50%;font-size:14px;line-height:24px;}
