                    ...
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            ...
                            <div class="widget-body am-fr">
                                ...
                                <form class="am-form tpl-form-line-form" action="{{ url('admin/GuangGao') }}" method="post" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                    <div class="am-form-group">
                                        <label for="user-name" class="am-u-sm-3 am-form-label">名称 <span class="tpl-form-line-small-title">Name</span></label>
                                        <div class="am-u-sm-9">
                                            <input type="text" class="tpl-form-input" id="user-name" placeholder="请输入广告链接名称" name="name">
                                            <small>请填写广告链接名称文字2-20字左右。</small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="text" class="tpl-form-input" id="user-name" placeholder="请输入友情链接地址" name="url">
                                            <small>请填写广告链接地址</small>
                                        </div>
                                    </div>
                                        ...
                                        <div class="am-u-sm-9">
                                            <div class="am-form-group am-form-file">
                                                <div class="tpl-form-file-img">
                                                    <img src="{{ asset('admins/assets/img/jiahao.jpg') }}" alt="">
                                                </div>
                                                <button type="button" class="am-btn am-btn-danger am-btn-sm">
    <i class="am-icon-cloud-upload"></i>点击添加缩略图</button>
                                                <input id="doc-form-file" type="file" multiple="" name="mypic" value="default.jpg">
                                            </div>
