                    ...
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            <div class="widget-head am-cf">
                                <div class="widget-title am-fl">更改友情链接</div>
                            ...
                            <div class="widget-body am-fr">
                                ...
                                <form class="am-form tpl-form-line-form" action="{{ url('admin/link').'/'.$link->id }}" method="post" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                    {{ method_field('PUT') }}
                                    <div class="am-form-group">
                                        <label for="user-name" class="am-u-sm-3 am-form-label">名称 <span class="tpl-form-line-small-title">Name</span></label>
                                        <div class="am-u-sm-9">
                                            <input type="text" class="tpl-form-input" id="user-name" placeholder="请输入新的友情链接名称" name="name" value="{{ $link->name }}">
                                            <small>请填写友情链接名称文字2-20字左右。</small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="text" class="tpl-form-input" id="user-name" placeholder="请输入新的友情链接地址" name="url" value="{{ $link->url }}">
                                            <small>请填写友情链接地址文字2-20字左右。</small>
                                        </div>
                                    </div>
                                        ...
                                        <div class="am-u-sm-9">
                                            <div class="am-form-group am-form-file">
                                                <div class="tpl-form-file-img">
                                                    <img src="{{ asset('upload') }}/{{ $link->image }}" class="tpl-table-line-img" alt="">
                                                </div>
