        ...
        <div class="tpl-login">
            <div class="tpl-login-content">
                ...
                <form class="am-form tpl-form-line-form"  onsubmit="return doLogin()">
                    ...
                    <div class="am-form-group">
                        <input type="text" name="name" class="tpl-form-input" id="code" placeholder="请输入验证码">
                        <img src="{{ url('admin/captcha/'.time()) }}" onclick="this.src='{{ url('admin/captcha/')}}/'+Math.random()">
                    </div>
                    <div class="am-form-group">
                        <input type="password" name="password" class="tpl-form-input" id="pass" placeholder="请输入密码">
                    </div>
                    <p style="color:red"></p>
                    <div class="am-form-group">
